...
%   and sets them in the structure 'gpsc'.  GPS_CONFIG must be called
%   only once, before 'gpsc' is accessed for the first time. Any function
%   that subsequently uses 'gpsc' must declare the variable as global:
%      global gpsc;
%
